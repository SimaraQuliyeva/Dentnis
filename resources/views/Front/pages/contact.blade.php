        ...
        <div class="section1">
            <div class="row1">
                <form action="{{route('front.contact')}}" method="post">
                    @csrf
                    <div class="flex">
                        <input type="text" name="fullname" placeholder="{{__("Ad, Soyad")}}" value="{{old('full_name')}}">
        ...
        <div class="section2">
            <div class="row1">
                ...
                @foreach($contacts as $contact)
                    <p><strong>{{__("Adres")}}:</strong> {{$contact->address}} </p>
                    <p><strong>{{__("Telefon")}}:</strong> <a href="">{{$contact->phone}} </a></p>
                    <p><strong>{{__("Mail")}}:</strong> <a href="">{{$contact->email}}</a></p>
                @endforeach
